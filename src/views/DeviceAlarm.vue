  ...
  <div class="deviceAlarm">
    ...
    <div class="content">
      <div class="downMessage">
        <el-button plain size="medium" icon="el-icon-download" class="btnChangeColor" @click="downloadData">导出</el-button>
      </div>
        ...
        <el-form label-width="100px" style="margin:20px 0">
            ...
            <el-col :span="5" :offset="1">
              <el-form-item label="设备名称">
                <el-select
                   ...
                   collapse-tags
                >
                  <el-option v-for="(item,index) of deviceNameOptions" :key="index" :label="item" :value="index">
                  </el-option>
                </el-select>
              </el-form-item>
            </el-col>
            <el-col :span="5" >
              <el-form-item label="设备编号">
                <el-select
                  ...
                  collapse-tags
                >
                  <el-option v-for="(item,index) of equipmentNoOptions" :key="index" :label="item" :value="index">
                  </el-option>
                </el-select>
              </el-form-item>
            </el-col>
            <el-col :span="5" >
              <el-form-item label="车牌号">
                <el-select
                   ...
                   collapse-tags
                >
                  <el-option v-for="(item,index) of plateNoOptions" :key="index" :label="item" :value="index">
                  </el-option>
                </el-select>
              </el-form-item>
            </el-col>
            <el-col :span="5" >
              <el-form-item label="风险类型">
                <el-select
                  ...
                  collapse-tags
                >
                  <el-option v-for="(item,index) of alarmTypeOptions" :key="index" :label="item" :value="index">
                  </el-option>
                </el-select>
              </el-form-item>
            </el-col>
          ...
          <el-row :gutter="24">
            <el-col :span="5" :offset="1">
              <el-form-item label="事件名称">
                <el-select v-model="eventName" placeholder="请选择" size="medium" collapse-tags>
                  <el-option v-for="(item,index) of eventNameOptions" :key="index" :label="item" :value="index">
                  </el-option>
                </el-select>
              </el-form-item>
            </el-col>
            <el-col :span="5" >
              <el-form-item label="处理状态">
                <el-select v-model="dealStatus" placeholder="请选择" size="medium" collapse-tags>
                  <el-option v-for="item in dealStatusOptions" :key="item.id" :label="item.value" :value="item.id">
                  </el-option>
                </el-select>
              </el-form-item>
            </el-col>
            <el-col :span="5" >
              ...
              <el-date-picker v-model="chooseTime" type="datetimerange" :editable="false" clearable size="medium" range-separator="-"
                              start-placeholder="开始日期" end-placeholder="结束日期" :picker-options="pickerOptions" align="center" :format="'yyyy-MM-dd HH:mm:ss'">
              </el-date-picker>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="24">
            <el-col :span="5" style="float: right;text-align: right">
              ...
              <el-button @click="doReset()" size="medium" icon="el-icon-refresh" class="btnChangeColor" plain>重置</el-button>
            </el-col>
          </el-row>
        </el-form>
        <div>
...
export default {
  ...
  methods:{
        ...
        if(res.data.code===200){
          ...
          for(let info of data){
            ...
            if(!keys.includes(info.alarmFrom)){
              Vue.set(this.alarmTypeOptions,info.alarmFrom,info.alarmFromName)
            }
          }
        }
      })
    ...
    initAlarmData(){
      ...
      let terminalIds = this.deviceName.concat(this.equipmentNo).concat(this.plateNo)
    ...
    downloadData(){
      ...
      this.$api.downAlarmListInfo(params).then(res=>{
        let fileName ='风险事件_'+dateFormat(new Date().getTime(),'yyyy年MM月dd日HH时mm分ss秒')

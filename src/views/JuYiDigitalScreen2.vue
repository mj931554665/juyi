<template>
  <div class="DigitalScreen" style="min-width: 1024px; min-height: 100vh">
    ...
    <div class="mainbox main">
      <div class="leftTree">
        <div class="leftTreeContent borderImg">
          ...
          <div class="leftTreeBottom">
            <div class="equipmentItem textFont14" v-for="i in 100" :key="i">
              <div class="itemContent">
                <div class="prevIconOnline"></div>
                <div>
                  <span>271</span>
                  <i class="el-icon-video-camera-solid videoOnlineClass"></i>
                </div>
              </div>
            </div>
          </div>
      ...
      <!-- <div class="bmap" style="width: 100%;height: 100%;position: absolute;top: 0;left: 0;background-color: #1cd6ed;z-index: 0;"></div> -->
    </div>
  </div>
</template>
...
.DigitalScreen {
  ...
  header {
    ...
    .headerTitle {
      ...
      height: 53px;
      width: 905px;
      background-image: url("@/assets/images/kzuqi/10010.png");
      background-repeat: no-repeat;
      background-size: 100% 100%;
      > div {
        position: absolute;

...
export default {
  ...
  getSelectBaseInfoByPage(equipmentNo,name,plateNo,types,pageNum, pageSize) {
  ...
  getEquipmentBusinessNameByNo(equipmentNos){
    ...
    return axios.post('/equipmentDepository/selectEquipmentBusinessNameByEquipmentNos',formData)
  },
  // 2.30.根据设备编号获取工况统计信息
  ...
  //2.31.根据设备编号获取工况明细信息
  getWorkDetailInfoByEquipmentNo(vehicleCodes,startDate,endDate,pageNum,pageSize){
    let formData = new FormData();
    formData.append('pageNum', pageNum);
    formData.append('pageSize', pageSize);
    formData.append('vehicleCodes', vehicleCodes);
